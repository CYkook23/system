                ...
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        ...
                        <a href="{{ route('clients.index') }}" > 
                            <button type="submit" class="btn btn-info text-light" style="padding: 6px 20px;">List Client</button></a>
                    </div>
                    <div class=" my-3 shadow  mb-5 bg-body-tertiary rounded">
                        <h3 class="card-header bg-dark text-center text-light">Create Client</h3>
                        <div class="card-body">
