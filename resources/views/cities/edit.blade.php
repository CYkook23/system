            ...
            <div class="row justify-content-center">
                <div class="col-md-5">
                    ...
                    <div class=" my-3 shadow  mb-5 bg-body-tertiary rounded">
                        <h3 class="card-header bg-dark text-center text-light">Edit City</h3>
                        <div class="card-body">
...
<form action="{{ route('cities.edit', $city)}}" method="post">
    ...
    <input type="text" name="name" id="name" placeholder="Enter city" value="{{ $city->name }}" class="form-control">
    @error('name')
