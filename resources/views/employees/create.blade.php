                ...
                <div class="row justify-content-center">
                    <div class="col-md-5">
                        ...
                        <a href="{{ route('employees.index') }}" > 
                            <button type="submit" class="btn btn-info text-light" style="padding: 6px 20px;">List Employee</button></a>
                    </div>
                    <div class=" my-3 shadow  mb-5 bg-body-tertiary rounded">
                        <h3 class="card-header bg-dark text-center text-light">Create Employee</h3>
                        <div class="card-body">
...
<form action="{{ route('employees.create') }}" method="post">
    ...
    <div style="margin-bottom: 1em;">
        ...
        <input type="text" name="identification_card" id="identification_card" placeholder="Enter Identification card" class="form-control">
